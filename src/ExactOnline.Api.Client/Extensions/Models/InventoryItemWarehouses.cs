...
public partial class InventoryItemWarehouses
{
    internal static readonly Dictionary<string, string> PropertyMapping = new()
    {
        ...
        { nameof(ItemIsFractionAllowedItem), "ItemIsFractionAllowedItem" },
        { nameof(ItemIsStockItem), "ItemIsStockItem" },
        ...
        { nameof(PlannedStockIn), "PlannedStockIn" },
        { nameof(PlannedStockOut), "PlannedStockOut" },
        { nameof(PlanningDetailsUrl), "PlanningDetailsUrl" },
        ...
        { nameof(StorageLocationUrl), "StorageLocationUrl" },
