...
public partial class FinancialTransactionBankEntries
{
    internal static readonly Dictionary<string, string> PropertyMapping = new()
    {
        { nameof(BankEntryLines), "BankEntryLines" },
        { nameof(BankStatementDocument), "BankStatementDocument" },
        { nameof(BankStatementDocumentNumber), "BankStatementDocumentNumber" },
        { nameof(BankStatementDocumentSubject), "BankStatementDocumentSubject" },
