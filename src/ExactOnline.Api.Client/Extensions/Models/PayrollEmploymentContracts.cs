...
public partial class PayrollEmploymentContracts
{
    internal static readonly Dictionary<string, string> PropertyMapping = new()
    {
        { nameof(ContractFlexPhase), "ContractFlexPhase" },
        { nameof(ContractFlexPhaseDescription), "ContractFlexPhaseDescription" },
        { nameof(CreateAutoCorrection), "CreateAutoCorrection" },
        { nameof(CreatePredecessorsForLinkedAgencies), "CreatePredecessorsForLinkedAgencies" },
