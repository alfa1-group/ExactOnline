...
namespace ExactOnline.Api.Client.Models
{
    ...
    public partial class CRMQuotation : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<UntypedNode>? QuotationLines { get; set; }
#nullable restore
#else
        public List<UntypedNode> QuotationLines { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<UntypedNode>? QuotationOrderChargeLines { get; set; }
#nullable restore
#else
        public List<UntypedNode> QuotationOrderChargeLines { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.CRMQuotation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ExactOnline.Api.Client.Models.CRMQuotation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ExactOnline.Api.Client.Models.CRMQuotation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "QuotationLines", n => { QuotationLines = n.GetCollectionOfPrimitiveValues<UntypedNode>()?.AsList(); } },
                { "QuotationNumber", n => { QuotationNumber = n.GetIntValue(); } },
                { "QuotationOrderChargeLines", n => { QuotationOrderChargeLines = n.GetCollectionOfPrimitiveValues<UntypedNode>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfPrimitiveValues<UntypedNode>("QuotationLines", QuotationLines);
            writer.WriteIntValue("QuotationNumber", QuotationNumber);
            writer.WriteCollectionOfPrimitiveValues<UntypedNode>("QuotationOrderChargeLines", QuotationOrderChargeLines);
