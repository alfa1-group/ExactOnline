...
namespace ExactOnline.Api.Client.Models
{
    ...
    public partial class SalesInvoiceSalesInvoice : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<UntypedNode>? SalesInvoiceLines { get; set; }
#nullable restore
#else
        public List<UntypedNode> SalesInvoiceLines { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<UntypedNode>? SalesInvoiceOrderChargeLines { get; set; }
#nullable restore
#else
        public List<UntypedNode> SalesInvoiceOrderChargeLines { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SalesInvoiceSalesInvoice"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ExactOnline.Api.Client.Models.SalesInvoiceSalesInvoice CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ExactOnline.Api.Client.Models.SalesInvoiceSalesInvoice();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "SalesInvoiceLines", n => { SalesInvoiceLines = n.GetCollectionOfPrimitiveValues<UntypedNode>()?.AsList(); } },
                { "SalesInvoiceOrderChargeLines", n => { SalesInvoiceOrderChargeLines = n.GetCollectionOfPrimitiveValues<UntypedNode>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfPrimitiveValues<UntypedNode>("SalesInvoiceLines", SalesInvoiceLines);
            writer.WriteCollectionOfPrimitiveValues<UntypedNode>("SalesInvoiceOrderChargeLines", SalesInvoiceOrderChargeLines);
