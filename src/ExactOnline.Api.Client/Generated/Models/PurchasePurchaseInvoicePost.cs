...
namespace ExactOnline.Api.Client.Models
{
    ...
    public partial class PurchasePurchaseInvoicePost : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<UntypedNode>? PurchaseInvoiceLines { get; set; }
#nullable restore
#else
        public List<UntypedNode> PurchaseInvoiceLines { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.PurchasePurchaseInvoicePost"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ExactOnline.Api.Client.Models.PurchasePurchaseInvoicePost CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ExactOnline.Api.Client.Models.PurchasePurchaseInvoicePost();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "PurchaseInvoiceLines", n => { PurchaseInvoiceLines = n.GetCollectionOfPrimitiveValues<UntypedNode>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfPrimitiveValues<UntypedNode>("PurchaseInvoiceLines", PurchaseInvoiceLines);
