...
namespace ExactOnline.Api.Client.Models
{
    ...
    public partial class SyncHRMAbsenceRegistration : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Collection of absence registration transactions</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<UntypedNode>? AbsenceRegistrationTransactions { get; private set; }
#nullable restore
#else
        public List<UntypedNode> AbsenceRegistrationTransactions { get; private set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? CauseCode { get; private set; }
#nullable restore
#else
        public string CauseCode { get; private set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncHRMAbsenceRegistration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ExactOnline.Api.Client.Models.SyncHRMAbsenceRegistration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ExactOnline.Api.Client.Models.SyncHRMAbsenceRegistration();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "AbsenceRegistrationTransactions", n => { AbsenceRegistrationTransactions = n.GetCollectionOfPrimitiveValues<UntypedNode>()?.AsList(); } },
