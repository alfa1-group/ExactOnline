...
namespace ExactOnline.Api.Client.Models
{
    ...
    public partial class LogisticsReasonCode : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<UntypedNode>? Types { get; private set; }
#nullable restore
#else
        public List<UntypedNode> Types { get; private set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.LogisticsReasonCode"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ExactOnline.Api.Client.Models.LogisticsReasonCode CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ExactOnline.Api.Client.Models.LogisticsReasonCode();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "Types", n => { Types = n.GetCollectionOfPrimitiveValues<UntypedNode>()?.AsList(); } },
            };
        }
        /// <summary>
