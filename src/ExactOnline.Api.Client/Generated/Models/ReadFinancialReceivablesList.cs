...
namespace ExactOnline.Api.Client.Models
{
    ...
    public partial class ReadFinancialReceivablesList : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ExactOnline.Api.Client.Models.ReadFinancialReceivablesList_Notes? Notes { get; set; }
#nullable restore
#else
        public global::ExactOnline.Api.Client.Models.ReadFinancialReceivablesList_Notes Notes { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Models.ReadFinancialReceivablesList"/> and sets the default values.
        /// </summary>
        public ReadFinancialReceivablesList()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.ReadFinancialReceivablesList"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ExactOnline.Api.Client.Models.ReadFinancialReceivablesList CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ExactOnline.Api.Client.Models.ReadFinancialReceivablesList();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "Notes", n => { Notes = n.GetObjectValue<global::ExactOnline.Api.Client.Models.ReadFinancialReceivablesList_Notes>(global::ExactOnline.Api.Client.Models.ReadFinancialReceivablesList_Notes.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ExactOnline.Api.Client.Models.ReadFinancialReceivablesList_Notes>("Notes", Notes);
