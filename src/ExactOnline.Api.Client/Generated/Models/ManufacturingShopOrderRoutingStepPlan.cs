...
namespace ExactOnline.Api.Client.Models
{
    ...
    public partial class ManufacturingShopOrderRoutingStepPlan : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<UntypedNode>? TimeTransactions { get; set; }
#nullable restore
#else
        public List<UntypedNode> TimeTransactions { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.ManufacturingShopOrderRoutingStepPlan"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ExactOnline.Api.Client.Models.ManufacturingShopOrderRoutingStepPlan CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ExactOnline.Api.Client.Models.ManufacturingShopOrderRoutingStepPlan();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "TimeTransactions", n => { TimeTransactions = n.GetCollectionOfPrimitiveValues<UntypedNode>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfPrimitiveValues<UntypedNode>("TimeTransactions", TimeTransactions);
