...
namespace ExactOnline.Api.Client.Models
{
    ...
    public partial class PayrollEmployee : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.PayrollEmployee"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ExactOnline.Api.Client.Models.PayrollEmployee CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ExactOnline.Api.Client.Models.PayrollEmployee();
        }
        /// <summary>
