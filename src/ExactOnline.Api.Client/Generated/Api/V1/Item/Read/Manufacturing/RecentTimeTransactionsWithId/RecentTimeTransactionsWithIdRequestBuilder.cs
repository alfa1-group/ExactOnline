...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Read.Manufacturing.RecentTimeTransactionsWithId
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v1\{division}\read\manufacturing\RecentTimeTransactions(guid'{id}')
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class RecentTimeTransactionsWithIdRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecentTimeTransactionsWithIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/read/manufacturing/RecentTimeTransactions(guid'{id}')", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Read.Manufacturing.RecentTimeTransactionsWithId.RecentTimeTransactionsWithIdRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Read.Manufacturing.RecentTimeTransactionsWithId.RecentTimeTransactionsWithIdRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RecentTimeTransactionsWithIdRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
