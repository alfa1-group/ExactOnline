...
namespace ExactOnline.Api.Client.Api.V1.Item.Read.Sync.Sync.SyncTimestamp
{
    ...
    public partial class SyncTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        public SyncTimestampRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/read/sync/Sync/SyncTimestamp?endPoint={endPoint}&modified={modified}{&%24filter*,%24orderby*,%24select*,%24skip*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Read.Sync.Sync.SyncTimestamp.SyncTimestampRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SyncTimestampRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/read/sync/Sync/SyncTimestamp?endPoint={endPoint}&modified={modified}{&%24filter*,%24orderby*,%24select*,%24skip*,%24top*}", rawUrl)
        {
        }
        /// <summary>
