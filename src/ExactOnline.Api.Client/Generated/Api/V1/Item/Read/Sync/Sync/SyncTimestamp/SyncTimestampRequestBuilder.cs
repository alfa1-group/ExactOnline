...
namespace ExactOnline.Api.Client.Api.V1.Item.Read.Sync.Sync.SyncTimestamp
{
    ...
    public partial class SyncTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        public SyncTimestampRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/read/sync/Sync/SyncTimestamp?endPoint={endPoint}&modified={modified}{&%24count*,%24expand*,%24filter*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Read.Sync.Sync.SyncTimestamp.SyncTimestampRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SyncTimestampRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/read/sync/Sync/SyncTimestamp?endPoint={endPoint}&modified={modified}{&%24count*,%24expand*,%24filter*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
