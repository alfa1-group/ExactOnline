...
using ExactOnline.Api.Client.Api.V1.Item.Read.Sync.Sync.SyncTimestampWithId;
...
namespace ExactOnline.Api.Client.Api.V1.Item.Read.Sync.Sync
{
    ...
    public partial class SyncRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::ExactOnline.Api.Client.Api.V1.Item.Read.Sync.Sync.SyncTimestampWithId.SyncTimestampWithIdRequestBuilder SyncTimestampWithId(Guid? id)
        {
            _ = id ?? throw new ArgumentNullException(nameof(id));
            return new global::ExactOnline.Api.Client.Api.V1.Item.Read.Sync.Sync.SyncTimestampWithId.SyncTimestampWithIdRequestBuilder(PathParameters, RequestAdapter, id);
        }
    }
}
