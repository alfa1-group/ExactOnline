...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Read.Financial.PayablesListByAgeGroupWithId
{
    /// <summary>
    ...
    public partial class PayablesListByAgeGroupWithIdRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PayablesListByAgeGroupWithIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/read/financial/PayablesListByAgeGroup(guid'{id}')", rawUrl)
        {
        }
        /// <summary>
        /// GET ReadFinancialPayablesListByAgeGroup
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.ReadFinancialPayablesListByAgeGroupGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.ReadFinancialPayablesListByAgeGroupGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.ReadFinancialPayablesListByAgeGroupGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.ReadFinancialPayablesListByAgeGroupGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.ReadFinancialPayablesListByAgeGroupGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET ReadFinancialPayablesListByAgeGroup
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Read.Financial.PayablesListByAgeGroupWithId.PayablesListByAgeGroupWithIdRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Read.Financial.PayablesListByAgeGroupWithId.PayablesListByAgeGroupWithIdRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class PayablesListByAgeGroupWithIdRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
