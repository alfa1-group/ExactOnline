...
namespace ExactOnline.Api.Client.Api.V1.Item.Inventory.StockBatchNumbersWithId
{
    ...
    public partial class StockBatchNumbersWithIdRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// DELETE InventoryStockBatchNumber
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.InventoryStockBatchNumberGet_Response"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::ExactOnline.Api.Client.Models.ODataError">When receiving a 400 status code</exception>
        /// <exception cref="global::ExactOnline.Api.Client.Models.ODataError">When receiving a 500 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.InventoryStockBatchNumberGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.InventoryStockBatchNumberGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.InventoryStockBatchNumberGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.InventoryStockBatchNumberGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// PUT InventoryStockBatchNumber
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task PutAsync(global::ExactOnline.Api.Client.Models.InventoryStockBatchNumberPut body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PutAsync(global::ExactOnline.Api.Client.Models.InventoryStockBatchNumberPut body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::ExactOnline.Api.Client.Models.InventoryStockBatchNumberPut body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::ExactOnline.Api.Client.Models.InventoryStockBatchNumberPut body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
