...
namespace ExactOnline.Api.Client.Api.V1.Item.Inventory.BatchNumbersWithId
{
    ...
    public partial class BatchNumbersWithIdRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.InventoryBatchNumberGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.InventoryBatchNumberGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.InventoryBatchNumberGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.InventoryBatchNumberGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.InventoryBatchNumberGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET InventoryBatchNumber
        /// </summary>
