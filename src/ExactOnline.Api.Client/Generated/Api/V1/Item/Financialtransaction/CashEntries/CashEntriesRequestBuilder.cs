...
namespace ExactOnline.Api.Client.Api.V1.Item.Financialtransaction.CashEntries
{
    ...
    public partial class CashEntriesRequestBuilder : BaseRequestBuilder
    {
        ...
        public CashEntriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/financialtransaction/CashEntries{?%24expand*,%24filter*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Financialtransaction.CashEntries.CashEntriesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CashEntriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/financialtransaction/CashEntries{?%24expand*,%24filter*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
