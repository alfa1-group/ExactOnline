...
namespace ExactOnline.Api.Client.Api.V1.Item.Salesorder.CompleteSalesOrderLine
{
    ...
    public partial class CompleteSalesOrderLineRequestBuilder : BaseRequestBuilder
    {
        ...
        public CompleteSalesOrderLineRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/salesorder/CompleteSalesOrderLine{?%24count*,%24expand*,%24filter*,%24inlinecount*,%24orderby*,%24select*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Salesorder.CompleteSalesOrderLine.CompleteSalesOrderLineRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompleteSalesOrderLineRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/salesorder/CompleteSalesOrderLine{?%24count*,%24expand*,%24filter*,%24inlinecount*,%24orderby*,%24select*,%24top*}", rawUrl)
        {
        }
        /// <summary>
