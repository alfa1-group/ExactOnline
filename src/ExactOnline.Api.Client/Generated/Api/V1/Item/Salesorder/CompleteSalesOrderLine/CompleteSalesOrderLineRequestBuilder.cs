...
namespace ExactOnline.Api.Client.Api.V1.Item.Salesorder.CompleteSalesOrderLine
{
    ...
    public partial class CompleteSalesOrderLineRequestBuilder : BaseRequestBuilder
    {
        ...
        public CompleteSalesOrderLineRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/salesorder/CompleteSalesOrderLine{?%24count*,%24expand*,%24filter*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Salesorder.CompleteSalesOrderLine.CompleteSalesOrderLineRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompleteSalesOrderLineRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/salesorder/CompleteSalesOrderLine{?%24count*,%24expand*,%24filter*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SalesOrderCompleteSalesOrderLinePost_Response"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SalesOrderCompleteSalesOrderLinePost_Response?> PostAsync(global::ExactOnline.Api.Client.Models.SalesOrderCompleteSalesOrderLinePost body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SalesOrderCompleteSalesOrderLinePost_Response> PostAsync(global::ExactOnline.Api.Client.Models.SalesOrderCompleteSalesOrderLinePost body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SalesOrderCompleteSalesOrderLinePost_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SalesOrderCompleteSalesOrderLinePost_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SalesOrderCompleteSalesOrderLine
        /// </summary>
