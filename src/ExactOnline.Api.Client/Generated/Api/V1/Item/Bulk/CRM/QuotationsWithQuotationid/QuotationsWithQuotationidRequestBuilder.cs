...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Bulk.CRM.QuotationsWithQuotationid
{
    /// <summary>
    ...
    public partial class QuotationsWithQuotationidRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public QuotationsWithQuotationidRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/bulk/CRM/Quotations({quotationid})", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Bulk.CRM.QuotationsWithQuotationid.QuotationsWithQuotationidRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Bulk.CRM.QuotationsWithQuotationid.QuotationsWithQuotationidRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
