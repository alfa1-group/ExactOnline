...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Payroll.EmploymentContractFlexPhasesWithId
{
    /// <summary>
    ...
    public partial class EmploymentContractFlexPhasesWithIdRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmploymentContractFlexPhasesWithIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/payroll/EmploymentContractFlexPhases(guid'{id}')", rawUrl)
        {
        }
        /// <summary>
        /// GET PayrollEmploymentContractFlexPhases
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.PayrollEmploymentContractFlexPhasesGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.PayrollEmploymentContractFlexPhasesGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.PayrollEmploymentContractFlexPhasesGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.PayrollEmploymentContractFlexPhasesGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.PayrollEmploymentContractFlexPhasesGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET PayrollEmploymentContractFlexPhases
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Payroll.EmploymentContractFlexPhasesWithId.EmploymentContractFlexPhasesWithIdRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Payroll.EmploymentContractFlexPhasesWithId.EmploymentContractFlexPhasesWithIdRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class EmploymentContractFlexPhasesWithIdRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
