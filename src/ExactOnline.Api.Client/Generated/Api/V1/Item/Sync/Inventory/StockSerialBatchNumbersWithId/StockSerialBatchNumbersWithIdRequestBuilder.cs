...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.StockSerialBatchNumbersWithId
{
    /// <summary>
    ...
    public partial class StockSerialBatchNumbersWithIdRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.StockSerialBatchNumbersWithId.StockSerialBatchNumbersWithIdRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="id">Unique identifier (GUID) of the SyncInventoryStockSerialBatchNumbers</param>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StockSerialBatchNumbersWithIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Guid? id = default) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Inventory/StockSerialBatchNumbers(guid'{id}')", pathParameters)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StockSerialBatchNumbersWithIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Inventory/StockSerialBatchNumbers(guid'{id}')", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.StockSerialBatchNumbersWithId.StockSerialBatchNumbersWithIdRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.StockSerialBatchNumbersWithId.StockSerialBatchNumbersWithIdRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.StockSerialBatchNumbersWithId.StockSerialBatchNumbersWithIdRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class StockSerialBatchNumbersWithIdRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
