...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.SerialBatchNumbersWithTimestamp
{
    ...
    public partial class SerialBatchNumbersWithTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="timestamp">The Timestamp of the SyncInventorySerialBatchNumber</param>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumberGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumberGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumberGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumberGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumberGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncInventorySerialBatchNumber
        /// </summary>
