...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.SerialBatchNumbersWithTimestamp
{
    /// <summary>
    ...
    public partial class SerialBatchNumbersWithTimestampRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.SerialBatchNumbersWithTimestamp.SerialBatchNumbersWithTimestampRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// <param name="timestamp">The Timestamp of the SyncInventorySerialBatchNumbers</param>
        public SerialBatchNumbersWithTimestampRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string timestamp = "") : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Inventory/SerialBatchNumbers({timestamp})", pathParameters)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SerialBatchNumbersWithTimestampRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Inventory/SerialBatchNumbers({timestamp})", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncInventorySerialBatchNumbers
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumbersGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumbersGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumbersGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumbersGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncInventorySerialBatchNumbersGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncInventorySerialBatchNumbers
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.SerialBatchNumbersWithTimestamp.SerialBatchNumbersWithTimestampRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.SerialBatchNumbersWithTimestamp.SerialBatchNumbersWithTimestampRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.SerialBatchNumbersWithTimestamp.SerialBatchNumbersWithTimestampRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SerialBatchNumbersWithTimestampRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
