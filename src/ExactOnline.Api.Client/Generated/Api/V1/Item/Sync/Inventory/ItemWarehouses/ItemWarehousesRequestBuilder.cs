...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.ItemWarehouses
{
    ...
    public partial class ItemWarehousesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// GET SyncInventoryItemWarehouse
        /// </summary>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncInventoryItemWarehouse_Response?> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.ItemWarehouses.ItemWarehousesRequestBuilder.ItemWarehousesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncInventoryItemWarehouse_Response> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.Inventory.ItemWarehouses.ItemWarehousesRequestBuilder.ItemWarehousesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncInventoryItemWarehouse_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncInventoryItemWarehouse_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncInventoryItemWarehouse
        /// </summary>
