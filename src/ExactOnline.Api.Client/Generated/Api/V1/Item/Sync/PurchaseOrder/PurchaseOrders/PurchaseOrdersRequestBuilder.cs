...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.PurchaseOrder.PurchaseOrders
{
    ...
    public partial class PurchaseOrdersRequestBuilder : BaseRequestBuilder
    {
        ...
        public PurchaseOrdersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/PurchaseOrder/PurchaseOrders?$filter={%24filter}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skiptoken*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.PurchaseOrder.PurchaseOrders.PurchaseOrdersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PurchaseOrdersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/PurchaseOrder/PurchaseOrders?$filter={%24filter}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
