...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Logistics.PurchaseItemPricesWithTimestamp
{
    ...
    public partial class PurchaseItemPricesWithTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="timestamp">The Timestamp of the SyncLogisticsPurchaseItemPrice</param>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncLogisticsPurchaseItemPriceGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncLogisticsPurchaseItemPriceGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncLogisticsPurchaseItemPriceGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncLogisticsPurchaseItemPriceGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncLogisticsPurchaseItemPriceGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncLogisticsPurchaseItemPrice
        /// </summary>
