...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Logistics.SalesItemPricesWithTimestamp
{
    /// <summary>
    ...
    public partial class SalesItemPricesWithTimestampRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Logistics.SalesItemPricesWithTimestamp.SalesItemPricesWithTimestampRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// <param name="timestamp">The Timestamp of the SyncLogisticsSalesItemPrices</param>
        public SalesItemPricesWithTimestampRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string timestamp = "") : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Logistics/SalesItemPrices({timestamp})", pathParameters)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SalesItemPricesWithTimestampRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Logistics/SalesItemPrices({timestamp})", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncLogisticsSalesItemPrices
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncLogisticsSalesItemPricesGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncLogisticsSalesItemPricesGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncLogisticsSalesItemPricesGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncLogisticsSalesItemPricesGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncLogisticsSalesItemPricesGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncLogisticsSalesItemPrices
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Logistics.SalesItemPricesWithTimestamp.SalesItemPricesWithTimestampRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.Logistics.SalesItemPricesWithTimestamp.SalesItemPricesWithTimestampRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.Logistics.SalesItemPricesWithTimestamp.SalesItemPricesWithTimestampRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SalesItemPricesWithTimestampRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
