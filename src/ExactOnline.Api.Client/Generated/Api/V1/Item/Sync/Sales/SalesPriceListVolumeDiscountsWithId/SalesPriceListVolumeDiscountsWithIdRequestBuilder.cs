...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Sales.SalesPriceListVolumeDiscountsWithId
{
    /// <summary>
    ...
    public partial class SalesPriceListVolumeDiscountsWithIdRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Sales.SalesPriceListVolumeDiscountsWithId.SalesPriceListVolumeDiscountsWithIdRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="id">Unique identifier (GUID) of the SyncSalesSalesPriceListVolumeDiscounts</param>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SalesPriceListVolumeDiscountsWithIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Guid? id = default) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Sales/SalesPriceListVolumeDiscounts(guid'{id}')", pathParameters)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SalesPriceListVolumeDiscountsWithIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Sales/SalesPriceListVolumeDiscounts(guid'{id}')", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Sales.SalesPriceListVolumeDiscountsWithId.SalesPriceListVolumeDiscountsWithIdRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.Sales.SalesPriceListVolumeDiscountsWithId.SalesPriceListVolumeDiscountsWithIdRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.Sales.SalesPriceListVolumeDiscountsWithId.SalesPriceListVolumeDiscountsWithIdRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SalesPriceListVolumeDiscountsWithIdRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
