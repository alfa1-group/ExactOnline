...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.SalesOrderHeadersWithTimestamp
{
    /// <summary>
    ...
    public partial class SalesOrderHeadersWithTimestampRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        ...
        /// <param name="timestamp">The Timestamp of the SyncSalesOrderSalesOrderHeader</param>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderHeaderGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderHeaderGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderHeaderGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderHeaderGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderHeaderGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncSalesOrderSalesOrderHeader
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.SalesOrderHeadersWithTimestamp.SalesOrderHeadersWithTimestampRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.SalesOrderHeadersWithTimestamp.SalesOrderHeadersWithTimestampRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.SalesOrderHeadersWithTimestamp.SalesOrderHeadersWithTimestampRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SalesOrderHeadersWithTimestampRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
