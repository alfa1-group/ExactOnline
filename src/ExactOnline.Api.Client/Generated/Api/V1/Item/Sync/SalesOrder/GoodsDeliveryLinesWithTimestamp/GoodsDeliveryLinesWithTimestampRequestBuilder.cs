...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.GoodsDeliveryLinesWithTimestamp
{
    ...
    public partial class GoodsDeliveryLinesWithTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="timestamp">The Timestamp of the SyncSalesOrderGoodsDeliveryLine</param>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLineGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLineGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLineGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLineGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLineGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncSalesOrderGoodsDeliveryLine
        /// </summary>
