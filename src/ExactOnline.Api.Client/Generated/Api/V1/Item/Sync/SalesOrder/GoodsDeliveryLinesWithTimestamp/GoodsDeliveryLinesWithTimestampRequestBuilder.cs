...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.GoodsDeliveryLinesWithTimestamp
{
    /// <summary>
    ...
    public partial class GoodsDeliveryLinesWithTimestampRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.GoodsDeliveryLinesWithTimestamp.GoodsDeliveryLinesWithTimestampRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// <param name="timestamp">The Timestamp of the SyncSalesOrderGoodsDeliveryLines</param>
        public GoodsDeliveryLinesWithTimestampRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string timestamp = "") : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines({Timestamp})", pathParameters)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GoodsDeliveryLinesWithTimestampRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines({Timestamp})", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncSalesOrderGoodsDeliveryLines
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLinesGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLinesGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLinesGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLinesGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncSalesOrderGoodsDeliveryLinesGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncSalesOrderGoodsDeliveryLines
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.GoodsDeliveryLinesWithTimestamp.GoodsDeliveryLinesWithTimestampRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.GoodsDeliveryLinesWithTimestamp.GoodsDeliveryLinesWithTimestampRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.GoodsDeliveryLinesWithTimestamp.GoodsDeliveryLinesWithTimestampRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class GoodsDeliveryLinesWithTimestampRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
