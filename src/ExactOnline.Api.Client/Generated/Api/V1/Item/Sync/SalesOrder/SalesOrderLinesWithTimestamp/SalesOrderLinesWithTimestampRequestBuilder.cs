...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.SalesOrder.SalesOrderLinesWithTimestamp
{
    ...
    public partial class SalesOrderLinesWithTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="timestamp">The Timestamp of the SyncSalesOrderSalesOrderLine</param>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderLineGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderLineGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderLineGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderLineGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncSalesOrderSalesOrderLineGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncSalesOrderSalesOrderLine
        /// </summary>
