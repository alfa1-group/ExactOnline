...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Financial.GLClassificationsWithTimestamp
{
    ...
    public partial class GLClassificationsWithTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="timestamp">The Timestamp of the SyncFinancialGLClassification</param>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncFinancialGLClassificationGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncFinancialGLClassificationGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncFinancialGLClassificationGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncFinancialGLClassificationGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncFinancialGLClassificationGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncFinancialGLClassification
        /// </summary>
