...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Project.Projects
{
    ...
    public partial class ProjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        public ProjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Project/Projects?$filter={%24filter}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skiptoken*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Project.Projects.ProjectsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Project/Projects?$filter={%24filter}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
