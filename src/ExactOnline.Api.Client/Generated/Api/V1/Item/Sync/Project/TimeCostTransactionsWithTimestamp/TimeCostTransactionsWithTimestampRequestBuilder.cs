...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Project.TimeCostTransactionsWithTimestamp
{
    ...
    public partial class TimeCostTransactionsWithTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="timestamp">The Timestamp of the SyncProjectTimeCostTransaction</param>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncProjectTimeCostTransactionGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncProjectTimeCostTransactionGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncProjectTimeCostTransactionGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncProjectTimeCostTransactionGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncProjectTimeCostTransactionGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncProjectTimeCostTransaction
        /// </summary>
