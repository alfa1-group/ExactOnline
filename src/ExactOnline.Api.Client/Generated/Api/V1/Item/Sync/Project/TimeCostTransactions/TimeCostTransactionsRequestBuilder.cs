...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Project.TimeCostTransactions
{
    ...
    public partial class TimeCostTransactionsRequestBuilder : BaseRequestBuilder
    {
        ...
        public TimeCostTransactionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Project/TimeCostTransactions?$filter={%24filter}{&%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Project.TimeCostTransactions.TimeCostTransactionsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TimeCostTransactionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Project/TimeCostTransactions?$filter={%24filter}{&%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
