...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.HRM.SchedulesWithTimestamp
{
    ...
    public partial class SchedulesWithTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="timestamp">The Timestamp of the SyncHRMSchedule</param>
        ...
        /// GET SyncHRMSchedule
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncHRMScheduleGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncHRMScheduleGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncHRMScheduleGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncHRMScheduleGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncHRMScheduleGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncHRMSchedule
        /// </summary>
