...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.HRM.ScheduleEntries
{
    ...
    public partial class ScheduleEntriesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A List&lt;global::ExactOnline.Api.Client.Models.SyncHRMScheduleEntries&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::ExactOnline.Api.Client.Models.SyncHRMScheduleEntries>?> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.HRM.ScheduleEntries.ScheduleEntriesRequestBuilder.ScheduleEntriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::ExactOnline.Api.Client.Models.SyncHRMScheduleEntries>> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.HRM.ScheduleEntries.ScheduleEntriesRequestBuilder.ScheduleEntriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::ExactOnline.Api.Client.Models.SyncHRMScheduleEntries>(requestInfo, global::ExactOnline.Api.Client.Models.SyncHRMScheduleEntries.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
