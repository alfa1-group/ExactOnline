...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.Employments
{
    ...
    public partial class EmploymentsRequestBuilder : BaseRequestBuilder
    {
        ...
        public EmploymentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Payroll/Employments?$filter={%24filter}&$top={%24top}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.Employments.EmploymentsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmploymentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Payroll/Employments?$filter={%24filter}&$top={%24top}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*}", rawUrl)
        {
        }
        /// <summary>
