...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.BankAccounts
{
    ...
    public partial class BankAccountsRequestBuilder : BaseRequestBuilder
    {
        ...
        public BankAccountsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Payroll/BankAccounts{?%24filter*,%24select*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.BankAccounts.BankAccountsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BankAccountsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Payroll/BankAccounts{?%24filter*,%24select*}", rawUrl)
        {
        }
        /// <summary>
