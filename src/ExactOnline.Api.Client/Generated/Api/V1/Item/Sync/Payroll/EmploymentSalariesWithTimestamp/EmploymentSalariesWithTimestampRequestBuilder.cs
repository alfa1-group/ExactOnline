...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentSalariesWithTimestamp
{
    /// <summary>
    ...
    public partial class EmploymentSalariesWithTimestampRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        ...
        /// <param name="timestamp">The Timestamp of the SyncPayrollEmploymentSalary</param>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentSalaryGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentSalaryGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentSalaryGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentSalaryGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentSalaryGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncPayrollEmploymentSalary
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentSalariesWithTimestamp.EmploymentSalariesWithTimestampRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentSalariesWithTimestamp.EmploymentSalariesWithTimestampRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentSalariesWithTimestamp.EmploymentSalariesWithTimestampRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class EmploymentSalariesWithTimestampRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
