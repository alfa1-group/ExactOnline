...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentTaxAuthoritiesGeneral
{
    ...
    public partial class EmploymentTaxAuthoritiesGeneralRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmploymentTaxAuthoritiesGeneralRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Payroll/EmploymentTaxAuthoritiesGeneral?$filter={%24filter}{&%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
