...
#nullable restore
        ...
        public async Task<List<global::ExactOnline.Api.Client.Models.SyncPayrollEmployees>> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.Employees.EmployeesRequestBuilder.EmployeesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::ExactOnline.Api.Client.Models.SyncPayrollEmployees>(requestInfo, global::ExactOnline.Api.Client.Models.SyncPayrollEmployees.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
