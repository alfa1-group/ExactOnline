...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.Employees
{
    ...
    public partial class EmployeesRequestBuilder : BaseRequestBuilder
    {
        ...
        public EmployeesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Payroll/Employees{?%24filter*,%24orderby*,%24select*,%24skip*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.Employees.EmployeesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmployeesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Payroll/Employees{?%24filter*,%24orderby*,%24select*,%24skip*,%24top*}", rawUrl)
        {
        }
        /// <summary>
