...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentOrganizationsWithTimestamp
{
    /// <summary>
    ...
    public partial class EmploymentOrganizationsWithTimestampRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentOrganizationsWithTimestamp.EmploymentOrganizationsWithTimestampRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// <param name="timestamp">The Timestamp of the SyncPayrollEmploymentOrganizations</param>
        public EmploymentOrganizationsWithTimestampRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string timestamp = "") : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Payroll/EmploymentOrganizations({timestamp})", pathParameters)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmploymentOrganizationsWithTimestampRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Payroll/EmploymentOrganizations({timestamp})", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncPayrollEmploymentOrganizations
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentOrganizationsGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentOrganizationsGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentOrganizationsGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentOrganizationsGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncPayrollEmploymentOrganizationsGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncPayrollEmploymentOrganizations
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentOrganizationsWithTimestamp.EmploymentOrganizationsWithTimestampRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentOrganizationsWithTimestamp.EmploymentOrganizationsWithTimestampRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.Payroll.EmploymentOrganizationsWithTimestamp.EmploymentOrganizationsWithTimestampRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class EmploymentOrganizationsWithTimestampRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
