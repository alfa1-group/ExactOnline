...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTermsWithTimestamp
{
    /// <summary>
    ...
    public partial class PaymentTermsWithTimestampRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTermsWithTimestamp.PaymentTermsWithTimestampRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// <param name="timestamp">The Timestamp of the SyncCashflowPaymentTerms</param>
        public PaymentTermsWithTimestampRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string timestamp = "") : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Cashflow/PaymentTerms({timestamp})", pathParameters)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PaymentTermsWithTimestampRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Cashflow/PaymentTerms({timestamp})", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncCashflowPaymentTerms
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTermsGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTermsGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTermsGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTermsGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTermsGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncCashflowPaymentTerms
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTermsWithTimestamp.PaymentTermsWithTimestampRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTermsWithTimestamp.PaymentTermsWithTimestampRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class PaymentTermsWithTimestampRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
