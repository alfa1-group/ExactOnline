...
using ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTermsWithId;
...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow
{
    ...
    public partial class CashflowRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTermsWithId.PaymentTermsWithIdRequestBuilder PaymentTermsWithId(Guid? id)
        {
            _ = id ?? throw new ArgumentNullException(nameof(id));
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTermsWithId.PaymentTermsWithIdRequestBuilder(PathParameters, RequestAdapter, id);
        }
    }
}
