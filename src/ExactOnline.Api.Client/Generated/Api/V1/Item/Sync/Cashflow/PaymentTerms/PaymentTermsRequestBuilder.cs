...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTerms
{
    ...
    public partial class PaymentTermsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A List&lt;global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTerms&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTerms>?> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTerms.PaymentTermsRequestBuilder.PaymentTermsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTerms>> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTerms.PaymentTermsRequestBuilder.PaymentTermsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTerms>(requestInfo, global::ExactOnline.Api.Client.Models.SyncCashflowPaymentTerms.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
