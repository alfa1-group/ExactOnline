...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTerms
{
    ...
    public partial class PaymentTermsRequestBuilder : BaseRequestBuilder
    {
        ...
        public PaymentTermsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Cashflow/PaymentTerms?$filter={%24filter}{&%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Cashflow.PaymentTerms.PaymentTermsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PaymentTermsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Cashflow/PaymentTerms?$filter={%24filter}{&%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
