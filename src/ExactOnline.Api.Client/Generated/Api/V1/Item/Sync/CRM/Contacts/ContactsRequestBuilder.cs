...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.Contacts
{
    ...
    public partial class ContactsRequestBuilder : BaseRequestBuilder
    {
        ...
        public ContactsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/CRM/Contacts?$filter={%24filter}&$top={%24top}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.Contacts.ContactsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContactsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/CRM/Contacts?$filter={%24filter}&$top={%24top}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*}", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncCRMContacts
