...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.AddressesWithTimestamp
{
    ...
    public partial class AddressesWithTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="timestamp">The Timestamp of the SyncCRMAddress</param>
        ...
        /// GET SyncCRMAddress
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncCRMAddressGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncCRMAddressGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncCRMAddressGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncCRMAddressGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncCRMAddressGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncCRMAddress
        /// </summary>
