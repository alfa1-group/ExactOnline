...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.Addresses
{
    ...
    public partial class AddressesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A List&lt;global::ExactOnline.Api.Client.Models.SyncCRMAddresses&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::ExactOnline.Api.Client.Models.SyncCRMAddresses>?> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.Addresses.AddressesRequestBuilder.AddressesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::ExactOnline.Api.Client.Models.SyncCRMAddresses>> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.Addresses.AddressesRequestBuilder.AddressesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::ExactOnline.Api.Client.Models.SyncCRMAddresses>(requestInfo, global::ExactOnline.Api.Client.Models.SyncCRMAddresses.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
