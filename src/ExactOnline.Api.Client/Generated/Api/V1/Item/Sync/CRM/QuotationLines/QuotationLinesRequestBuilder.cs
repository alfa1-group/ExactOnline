...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationLines
{
    ...
    public partial class QuotationLinesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public QuotationLinesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/CRM/QuotationLines?$filter={%24filter}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncCRMQuotationLines
        /// </summary>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncCRMQuotationLines_Response?> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationLines.QuotationLinesRequestBuilder.QuotationLinesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncCRMQuotationLines_Response> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationLines.QuotationLinesRequestBuilder.QuotationLinesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncCRMQuotationLines_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncCRMQuotationLines_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncCRMQuotationLines
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationLines.QuotationLinesRequestBuilder.QuotationLinesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationLines.QuotationLinesRequestBuilder.QuotationLinesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationLines.QuotationLinesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationLines.QuotationLinesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationLines.QuotationLinesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// GET SyncCRMQuotationLines
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class QuotationLinesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationLines.QuotationLinesRequestBuilder.QuotationLinesRequestBuilderGetQueryParameters>
        {
        }
    }
}
