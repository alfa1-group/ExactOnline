...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationHeaders
{
    ...
    public partial class QuotationHeadersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public QuotationHeadersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/CRM/QuotationHeaders?$filter={%24filter}{&%24count*,%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncCRMQuotationHeader
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncCRMQuotationHeader_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncCRMQuotationHeader_Response?> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationHeaders.QuotationHeadersRequestBuilder.QuotationHeadersRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncCRMQuotationHeader_Response> GetAsync(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationHeaders.QuotationHeadersRequestBuilder.QuotationHeadersRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncCRMQuotationHeader_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncCRMQuotationHeader_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncCRMQuotationHeader
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationHeaders.QuotationHeadersRequestBuilder.QuotationHeadersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationHeaders.QuotationHeadersRequestBuilder.QuotationHeadersRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationHeaders.QuotationHeadersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationHeaders.QuotationHeadersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationHeaders.QuotationHeadersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// GET SyncCRMQuotationHeader
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class QuotationHeadersRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class QuotationHeadersRequestBuilderGetRequestConfiguration : RequestConfiguration<global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.QuotationHeaders.QuotationHeadersRequestBuilder.QuotationHeadersRequestBuilderGetQueryParameters>
        {
        }
    }
}
