...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.AccountsWithTimestamp
{
    ...
    public partial class AccountsWithTimestampRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="timestamp">The Timestamp of the SyncCRMAccount</param>
        ...
        /// GET SyncCRMAccount
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncCRMAccountGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncCRMAccountGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncCRMAccountGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncCRMAccountGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncCRMAccountGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncCRMAccount
        /// </summary>
