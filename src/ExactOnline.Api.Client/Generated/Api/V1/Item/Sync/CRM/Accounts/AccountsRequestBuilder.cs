...
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.Accounts
{
    ...
    public partial class AccountsRequestBuilder : BaseRequestBuilder
    {
        ...
        public AccountsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/CRM/Accounts?$filter={%24filter}{&%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.CRM.Accounts.AccountsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccountsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/CRM/Accounts?$filter={%24filter}{&%24expand*,%24inlinecount*,%24orderby*,%24select*,%24skip*,%24skiptoken*,%24top*}", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncCRMAccount
