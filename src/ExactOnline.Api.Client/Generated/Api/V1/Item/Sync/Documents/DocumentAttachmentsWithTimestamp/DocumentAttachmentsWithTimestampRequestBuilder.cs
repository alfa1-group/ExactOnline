...
using System;
namespace ExactOnline.Api.Client.Api.V1.Item.Sync.Documents.DocumentAttachmentsWithTimestamp
{
    /// <summary>
    ...
    public partial class DocumentAttachmentsWithTimestampRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.Item.Sync.Documents.DocumentAttachmentsWithTimestamp.DocumentAttachmentsWithTimestampRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// <param name="timestamp">The Timestamp of the SyncDocumentsDocumentAttachments</param>
        public DocumentAttachmentsWithTimestampRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string timestamp = "") : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Documents/DocumentAttachments({Timestamp})", pathParameters)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DocumentAttachmentsWithTimestampRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/{division}/sync/Documents/DocumentAttachments({Timestamp})", rawUrl)
        {
        }
        /// <summary>
        /// GET SyncDocumentsDocumentAttachments
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.SyncDocumentsDocumentAttachmentsGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.SyncDocumentsDocumentAttachmentsGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.SyncDocumentsDocumentAttachmentsGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.SyncDocumentsDocumentAttachmentsGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.SyncDocumentsDocumentAttachmentsGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET SyncDocumentsDocumentAttachments
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Item.Sync.Documents.DocumentAttachmentsWithTimestamp.DocumentAttachmentsWithTimestampRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Item.Sync.Documents.DocumentAttachmentsWithTimestamp.DocumentAttachmentsWithTimestampRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class DocumentAttachmentsWithTimestampRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
