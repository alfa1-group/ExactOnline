...
namespace ExactOnline.Api.Client.Api.V1.Beta.Item.Workflow.RequestAttachmentsWithId
{
    ...
    public partial class RequestAttachmentsWithIdRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET WorkflowRequestAttachment
        /// </summary>
