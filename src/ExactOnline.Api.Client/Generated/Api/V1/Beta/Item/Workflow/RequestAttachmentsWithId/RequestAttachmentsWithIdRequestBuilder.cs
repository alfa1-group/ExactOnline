...
namespace ExactOnline.Api.Client.Api.V1.Beta.Item.Workflow.RequestAttachmentsWithId
{
    ...
    public partial class RequestAttachmentsWithIdRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentsGet_Response"/></returns>
...
#nullable enable
        public async Task<global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentsGet_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentsGet_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentsGet_Response>(requestInfo, global::ExactOnline.Api.Client.Models.WorkflowRequestAttachmentsGet_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// GET WorkflowRequestAttachments
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ExactOnline.Api.Client.Api.V1.Beta.Item.Workflow.RequestAttachmentsWithId.RequestAttachmentsWithIdRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ExactOnline.Api.Client.Api.V1.Beta.Item.Workflow.RequestAttachmentsWithId.RequestAttachmentsWithIdRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RequestAttachmentsWithIdRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
