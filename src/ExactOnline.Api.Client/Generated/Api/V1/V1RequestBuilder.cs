...
using ExactOnline.Api.Client.Api.V1.Beta;
using ExactOnline.Api.Client.Api.V1.Current;
using ExactOnline.Api.Client.Api.V1.Item;
...
namespace ExactOnline.Api.Client.Api.V1
{
    ...
    public partial class V1RequestBuilder : BaseRequestBuilder
    {
        ...
        public global::ExactOnline.Api.Client.Api.V1.Beta.BetaRequestBuilder Beta
        {
            get => new global::ExactOnline.Api.Client.Api.V1.Beta.BetaRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The current property</summary>
        public global::ExactOnline.Api.Client.Api.V1.Current.CurrentRequestBuilder Current
        {
            get => new global::ExactOnline.Api.Client.Api.V1.Current.CurrentRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ExactOnline.Api.Client.Api.V1.V1RequestBuilder"/> and sets the default values.
        /// </summary>
